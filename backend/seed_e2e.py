...
Safety rules:
- Refuses to run unless E2E_SEED_ALLOWED=true.
- Refuses to seed when the target email already exists.
- Intended only for disposable CI/staging smoke databases.
"""
