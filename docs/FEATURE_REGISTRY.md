...
| Pay Owners | capability | release.accounting.pay_owners | owner_payouts | yes | ACCOUNTING.MANAGEMENT_FEES | no | ⬜ hidden implementation present | Staff preview owner balances and masked ACH readiness, create durable drafts, then record externally completed payouts through central GL posting; app does not initiate payment |
